...
//To verify the dates passed for booking or to edit booking
...
// Reload list of rooms available later with api data
...
// Reload my booking list with api data
...
// Reload liste of rooms with api data
...
$(document).ready(function () {
    ...
    Vue.component('room-item-later', {
        props: ['room'],
        template: '<div class="room">' +
        '<div class="room-infos datetimeform">' +
        '<span class="room-name">{{room.name}}</span>' +
        '<span class="room-location">{{room.location}} • Bâtiment {{room.building }} • Étage {{room.floor}} {{room.comment ? "•":""}} {{room.comment}}</span>' +
        '<span class="room-type">{{room.capacity}} Personnes • {{room.type}}</span>' +
        '</div>' +
        ...
        '<tr>'+
        	...
        	'</td>' +
        	'<td>' +    
        		'<input id="start-date{{room.id}}" type="date"/>' +
        	'</td>' +
        '</tr>'+
        '<tr>'+
        	'<td>' +
        	...
        	'</td>' +
        	'<td>' +    
        		'<input id="start-time{{room.id}}" type="time"/>' +
        	'</td>' +
        '</tr>'+
        '<tr>'+
        	'<td>' +
        	...
        	'</td>' +
        	'<td>' +    
        		'<input id="end-date{{room.id}}" type="date"/>' +
        	'</td>' +
        '</tr>'+
        '<tr>'+
        	'<td>' +
        	...
        	'</td>' +
        	'<td>' +  
        		'<input id="end-time{{room.id}}" type="time"/>' +
        	'</td>' +
        '</tr>'+
        '</table>' +
        '<div class="room-icons">' +
